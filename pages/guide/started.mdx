...
Most languages does not provide compile-time conversion of Lambdas to Expression Trees, which is one of the reasons why the .NET ORM can be designed to be very easy to use.
